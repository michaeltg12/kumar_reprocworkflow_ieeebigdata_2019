...
dqrdata = pd.read_csv("met_dqr_reproc_per_year.txt", index_col=0)
...
layout = go.Layout(
      # Set title to plot
      title = "Data Quality Reports for MET Instruments",
...
plotly.offline.plot(fig, filename='met_reproc_by_year.html')
